...
export default class Register extends Component {
  ...
  RegisterUser = () =>{
    ...
    // Password validations
      ...
      var InsertAPIURL = "http://192.168.1.11/api/users/SignUp.php";   //API to render signup
    ...
    .then((response)=>{
      ...
      this.props.navigation.navigate("LoginScreen"); //Navigate to next screen if authentications are valid
    })
    .catch((error)=>{
